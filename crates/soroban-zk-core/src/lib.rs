...
impl Bn254 {
    ...
    /// G2 curve coefficient β = 3 / (u + 9) in Fq².
    ///
    /// The BN254 G2 curve is defined over Fq² by `y² = x³ + β`, where the
    /// sextic twist is `ξ = u + 9` and `β = b / ξ = 3 / (u + 9)`. Expanding
    /// `(9 + u)⁻¹ = (9/82) - (1/82)·u` (since `u² = -1`) gives:
    ///   β = (27/82) - (3/82)·u
    /// Stored as `(real, imaginary)`.
    ...
    pub const G2_B_IMAG: u256 = u256::from_words(
        0x9713b03af0fed4cd2cafadeed8fdf4_u128,
