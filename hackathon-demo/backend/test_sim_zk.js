...
const CONTRACT_ID = process.env.CONTRACT_ID || 'CC5KGHEE6JB3ICEI3B4GCLMPFETSN5J44FCQLZN7TUWKG4E2TUKXI7CY';
...
async function test() {
  ...
  let tx = new TransactionBuilder(sourceAccount, { fee: '100000', networkPassphrase: NETWORK_PASSPHRASE }).addOperation(op).setTimeout(30).build();
