...
const CONTRACT_ID = 'CBGILJ5PSIDMDNET4M7Z55DX6SUPLG7AJIH6CGDFNJZU5QKQIBXVWN26';
...
async function test() {
  ...
  let tx1 = new TransactionBuilder(sourceAccount, { fee: '100000', networkPassphrase: Networks.TESTNET }).addOperation(shieldOp).setTimeout(30).build();
  ...
  let tx2 = new TransactionBuilder(sourceAccount2, { fee: '100000', networkPassphrase: Networks.TESTNET }).addOperation(op).setTimeout(30).build();
